  ...
  export default {
        ...
        images: [
          {
            ...
            videoLink: 'https://www.youtube.com/@programmersohan599',
    ...
    methods: {
      ...
      prevImage() {
        ...
        this.zoom.hide(); // Hide zoomed image when changing to the previous one
      },
      nextImage() {
        this.currentIndex = (this.currentIndex + 1) % this.images.length;
        this.zoom.hide(); // Hide zoomed image when changing to the next one
      },
      toggleZoom() {
